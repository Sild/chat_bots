...
pub fn format_response_room_info(rooms: &Vec<model::Flat>, persons: &Vec<model::Person>, person_rooms: &Vec<model::PersonRoom>) -> String {
...
pub fn format_response_person_info(persons: &Vec<model::Person>, rooms: &Vec<model::Flat>, person_rooms: &Vec<model::PersonRoom>, role: &PersonRole) -> String {
    let mut response = String::new();
    for p in persons {
