...
func newPoll(bot *telego.Bot, db database.DB) error {
...
func addPollOption(bot *telego.Bot, db database.DB) error {
...
func finishPollPrepare(bot *telego.Bot, db database.DB) error {
